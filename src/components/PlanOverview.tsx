...
const steps: StepCard[] = [
  {
    ...
    items: [
      ...
      { status: 'prog', text: 'Comparatif strategique A vs B vs C' },
    ],
    footer: 'Document plateforme 3 scenarios — EXCO / Cheick',
  ...
  },
  {
    ...
    footer: 'Brand Book draft 3 pistes — brief Fernand',
  ...
  },
  {
    ...
    items: [
      ...
      { status: 'done', text: '3 scenarios + bardade bronze' },
      { status: 'prog', text: 'Noms impactants 3 positionnements' },
