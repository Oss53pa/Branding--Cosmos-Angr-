...
export const journeyStages: JourneyStage[] = [
  ...
  },
  {
    ...
    layers: {
      ...
      touchPhys:   ['Atrium central avec verrière zénithale 12m de haut', 'Végétalisation tropicale 3 niveaux (palmiers 8m, plantes suspendues)', 'Murs intérieurs beige (Sable Territorial) + têtes de mur Kutu Baffle noyer fumé', 'Espace événementiel central modulable 120m² (scène + son)', 'Écrans LED grand format ×4 (contenu rotatif enseignes/événements)', 'Mobilier design lounge central (banquettes gold/navy)', 'Fontaine/miroir d\'eau central (signature architecturale)'],
