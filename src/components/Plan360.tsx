    ...
    actions: [
      {
        ...
        comment: 'Consultant Yvan + Designer Fernand. Focus group 8 personnes CSP+ Angré/Cocody. 3 itérations max. Validation finale PA.',
        ...
        resp: 'Yvan + Fernand + PA', livrable: 'Brand Book PDF HD + fichiers sources AI/EPS/PNG',
      ...
      },
      {
        ...
        comment: 'Contenu PA. Maquette Fernand. Impression offset locale.',
        dates: [{ j: '15/04/2026', desc: 'Contenu finalisé PA' }, { j: '30/04/2026', desc: 'Maquette validée' }, { j: '10/05/2026', desc: 'Bon à tirer signé' }, { j: '20/05/2026', desc: '✅ 500 exemplaires livrés' }],
        ...
        resp: 'PA + Fernand + Direction Commerciale', livrable: '500 brochures · PDF interactif · Kit digital enseignes',
  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        dates: [{ j: '01/04/2026', desc: 'Longlist 50 influenceurs' }, { j: '01/05/2026', desc: 'Shortlist 20 — validation PA' }, { j: '01/06/2026', desc: '✅ Contrats signés' }, { j: '15/06/2026', desc: 'Briefing + visite chantier exclusive' }, { j: '16/07/2026', desc: '✅ ACTIVATION — 1ers posts' }, { j: '16/10/2026', desc: 'Live Soft Opening — tous mobilisés' }, { j: '16/11/2026', desc: 'Live Inauguration — contenus premium' }],
      ...
      },
      {
        ...
        resp: 'PA + DG (porte-parole) + Agence RP', livrable: 'Dossier presse PDF+print · Rapport retombées · Revue de presse',
  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        resp: 'DG + PA + Agence événementielle', livrable: 'Programme soirée · Liste validée · Dossier presse inaug · Reportage',
    ...
    actions: [
      {
        ...
        resp: 'PA + Operations + Toutes enseignes', livrable: 'Reportage photo/vidéo · Rapport trafic J0 · Rapport CA enseignes',
      ...
      },
      {
        ...
        resp: 'DG + PA + Agence événementielle', livrable: 'Film inauguration 3 min · Reportage premium · Retombées J+15',
