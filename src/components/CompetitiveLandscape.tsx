...
const competitors = [
  ...
  { name: 'PlaYce Palmeraie', pos: 'Mass market accessible', cible: 'Classe moyenne Cocody Riviera', exp: 'Standard', surface: '29 000 m²', enseignes: 'Carrefour Market, Jules, San Marina, Cache-Cache, Burger King', forces: 'Localisation Cocody, marques mass market françaises (CFAO)', isCosmos: false },
  ...
  { name: 'Cap Sud', pos: 'Premium fonctionnel', cible: 'CSP+ Marcory Zone 4', exp: 'Classique', surface: '20 000 m²', enseignes: 'Hugo Boss, Swarovski, Mont Blanc, Nespresso, Patchi, FNAC', forces: 'Enseignes luxe les plus denses d\'Abidjan, ancienneté', isCosmos: false },
  { name: 'Cap Nord', pos: 'Proximité petit format', cible: 'Résidents Cocody Riviera', exp: 'Basique', surface: '1 900 m²', enseignes: '15 boutiques', forces: 'Proximité résidentielle Riviera', isCosmos: false },
