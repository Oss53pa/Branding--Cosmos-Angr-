...
function generatePlanMarketingHTML() {
  ...
  const scenarios = [
    { key: 'A', label: 'Scénario A — Premium de proximité', accent: '#4A7558', grad: 'linear-gradient(135deg,#1a2e20,#2a4a35,#1a2e20)',
      ...
      ton: "Chaleureux mais jamais banal. La sophistication passe par les actes. Pensez Nespresso — pas Darty.",
      risk: { label: 'Risques', text: "Risque de ne pas se différencier suffisamment de Yopougon. Difficulté à justifier les loyers premium." },
    },
    { key: 'B', label: 'Scénario B — Destination premium', accent: '#0D1B4B', grad: 'linear-gradient(135deg,#0d1b3e,#1a3060,#0d1b3e)',
      ...
      ton: "Inspirant, aspirationnel, confident. Le ton d'un hôtel 5 étoiles — chaleureux mais jamais banal.",
      risk: { label: 'Risques', text: "Risque d'aliéner une partie de la base client Cocody. Pression sur la qualité des enseignes." },
    },
    { key: 'C', label: "Scénario C — L'Exception Naturelle", accent: '#C9943A', grad: 'linear-gradient(135deg,#2C1A0A,#B25A38,#2C1A0A)',
      ...
      ton: "Affirmatif et chaleureux. Sophistiqué sans être distant. Pensez le Four Seasons d'un quartier vivant.",
      risk: { label: 'Avantage stratégique', text: "Seul scénario qui capture simultanément la cible aspiration et la cible proximité. Identité terracotta non réplicable. Grille de loyers justifiée." },
    },
    { key: 'D', label: 'Scénario D — Nature Contemporaine', accent: '#898D5D', grad: 'linear-gradient(135deg,#1C2215,#3D4A2A,#1C2215)',
      ...
      ton: "Vivant, raffiné, désirable. Le ton d'Aesop — nature et premium ne s'opposent pas.",
      risk: { label: 'Avantage stratégique', text: "L'identité végétale est un marqueur unique inimitable. La végétation mature prend 5 ans, créant une barrière naturelle à la copie." },
    },
  ];
